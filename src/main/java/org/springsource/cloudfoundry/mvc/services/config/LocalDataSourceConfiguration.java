...
public class LocalDataSourceConfiguration   {
    ...
    public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean( DataSource dataSource  ) throws Exception {
        ...
        em.setPackagesToScan(Customer.class.getPackage().getName(), Product.class.getPackage().getName());
    ...
    public CacheManager cacheManager() throws Exception {
        ...
        Cache cacheParameters = new ConcurrentMapCache("parameters");


        scm.setCaches(Arrays.asList(cache, cacheProducts, cacheParameters));
        return scm;
    }
